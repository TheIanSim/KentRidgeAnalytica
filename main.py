...
node_remove_timestep = 10



test_sim = Simulation(bad_guys=bad_guys, good_guys = good_guys, good_guys_enter_timestep = good_guys_enter_timestep)
...
test_sim.data_out_to_file("gephi_output6.csv")
